  ...
  return (
    <section className="hero">
      ...
      <p className="hero-desc">
        Celebrate and empower Kenya's creative geniuses. Support your favorite musicians, DJs, producers, and creators through tipped votes. Every <strong>10 KES</strong> tipped awards <strong>1 Vote</strong> directly to the artist.
      </p>
